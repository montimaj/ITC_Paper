...
\usepackage{lineno,hyperref, graphicx, amsmath, esvect, amssymb, ragged2e, titlesec, afterpage, placeins}
...
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[t]{\textwidth}
        \raisebox{-\height}{\includegraphics[width=\textwidth]{Figures/Results/Area_Elevation.png}}
        \caption{Layover, forest, surface scattering, volume scattering, and snow cover areas.}
        \label{subfig:area_elevation}
    \end{subfigure}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%second row
    \begin{subfigure}[t]{\textwidth}
        \raisebox{-\height}{\includegraphics[width=\textwidth]{Figures/Results/SD_Elevation.png}}
        \caption{Mean FSD and SSD over different elevation classes.}
        \label{subfig:sd_elevation}
    \end{subfigure}
    \caption{All the SD estimates are rounded to 2 decimal places. Also, \subref{subfig:area_elevation} has been generated in a similar way as that of Figure \ref{subfig:area_aspect}. Similarly, the standard errors like those in Figure \ref{subfig:sd_aspect} are reported.}
...
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[t]{\textwidth}
        \raisebox{-\height}{\includegraphics[width=\textwidth]{Figures/Results/Area_Slope.png}}
        \caption{Layover, forest, surface scattering, volume scattering, and snow cover areas.}
        \label{subfig:area_slope}
    \end{subfigure}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%second row
    \begin{subfigure}[t]{\textwidth}
        \raisebox{-\height}{\includegraphics[width=\textwidth]{Figures/Results/SD_Slope.png}}
...
\begin{figure}[htb]
    \centering
    \begin{subfigure}[t]{\textwidth}
        \raisebox{-\height}{\includegraphics[width=\textwidth]{Figures/Results/FSWE.png}}
        \caption{}
        \label{subfig:fswe_map}
    \end{subfigure}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%second row
    \begin{subfigure}[t]{\textwidth}
        \raisebox{-\height}{\includegraphics[width=\textwidth]{Figures/Results/SSWE.png}}
        \caption{}
        \label{subfig:sswe_map}
    \end{subfigure}
    \caption{Zoomed views of the \subref{subfig:fswe_map} FSWE map and \subref{subfig:sswe_map} SSWE map for January 8, 2016. The ground points in these maps are the exact same ones shown in Figure \ref{fig:sd_maps}.}
    \label{fig:swe_maps}
\end{figure}
